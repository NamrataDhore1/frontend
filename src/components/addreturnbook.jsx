 ...
 const ReturnBookForm = (props) => {
     ...
     const schema = {
      ...
      const handleSubmit = (event) => {
       ...
       if (errors) return;
        axios
          .post("http://localhost:8081/lms/returnbooks", bookreturned)
     ...
     return (  
       <div>
        <Typography variant="h3">Reurn Book</Typography>
        <Grid container>
          ...
          {errMsg && <Alert severity="error">{errMsg}</Alert>}
            ...
            <Box mb={3}>
              ...
              />
               {errors && (
                <Typography variant="caption">{errors.penaltyStatus}</Typography>
              )}
            </Box>
