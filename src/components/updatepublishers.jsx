...
class UpdatePublisher extends React.Component {
    state={
        publisher:{
...
componentDidMount() {
    axios
      .get(
        `http://localhost:8081/api/viewPublishersbyId/${this.props.match.params.id}`
      )
      .then((res) => {
  ...
  handleSubmit = (event) => {
    ...
    axios
      .put(
        "http://localhost:8081/api/updatePublisher",
        publisher
      )
      .then((res) => {
